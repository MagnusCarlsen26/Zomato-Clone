...
export default function Footer() {
    return (
        <div style={{backgroundColor:'#f8f8f8'}} className='abcde'> 
            <div className='footer'>
                <ul>
                    <li className='khushal'>About Zomato</li>
                    <li>Who We Are</li>
                    <li>Blog</li>
                    <li>Work With Us</li>
                ...
                <ul>
                    <li className='khushal'> ZOMAVERSE</li>
                    <li>Zomato</li>
                    <li>Blinkit</li>
                    <li>Feeding India</li>
                    <li>Hyperpure</li>
                ...
                <div>
                    <ul>
                        <li className='khushal'>For Restaurants</li>
                        <li>Partner With Us</li>
                        <li>Apps For You</li>
                    </ul>
                    <ul>
                        <li className='khushal'>FOR ENTERPRISES</li>
                        <li>Zomato For Enterprise</li>
                    </ul>
                </div>
                <ul>
                    <li className='khushal'>Learn More</li>
                    <li>Privacy</li>
                    <li>Security</li>
                    <li>Terms</li>
                    <li>SiteMap</li>
